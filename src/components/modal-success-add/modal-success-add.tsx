        ...
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            ...
            <div className="modal__button-container modal__button-container--add">
              ...
              <Link to={generatePath(AppRoute.Main)}><button className="button button--black-border button--small modal__button modal__button--right" onClick={()=> handleContinueClick()}>Продолжить покупки</button></Link>
            </div>
